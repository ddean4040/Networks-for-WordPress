...
1. RECOMMENDED: Comment out `DOMAIN_CURRENT_SITE` line in your `wp-config.php` file.
...
* Changed: allow Site assignment page to continue even if blog option keys are missing
